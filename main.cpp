...
int GiaoDienChinh()
{
	...
	//Thanh phan cua menu
	string ChucNang[] = {
		"COLOR PIGMENTS ACCORDING TO THE SCAN LINE",
		"PAINT THE SPOTS OF OIL",
		"EXIT (OR PRESS ESC)"	
	};
	...
	while(exitFlag!=1)
	{
		XoaManHinh();
		TextColor(MauChuMD);
		cout<<"\n___________________________ SCANLINE __________________________";
...
int Thoat()
{
	...
	{
		TextColor(MauChuMD);
		gotoxy(32,2); cout<<"YOU WANT TO EXIT?";
...
{
	// Thuat toan
	cout<<"\n_______________________________Scanline______________________________";
	thuatToan = 1;
	VeDaGiac();
}
...
void VeDaGiac()
{
	cout<<"\n\n- Draw polygons that need coloring with mouse.\n- Double-click at the final interception to end.";
...
void GiaoDienDauLoang()
{
	cout<<"\n______________________________Oil slick algorithm______________________________";
	thuatToan = 2;
	VeDaGiac();	
}
...
{
	nhay:
	cout<<"\nClick on a point in the polygon to color...";
	Point p;
	...
	{
		cout<<"\nThe point P you clicked is not in the polygon.";
		goto nhay;
